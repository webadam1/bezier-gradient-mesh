...
const shaderCPMatrix = [
  [{r: 1., g: 1., b: 1.}, {r: 0., g: 1., b: 1.}, {r: 0., g: 1., b: 0.5}],
  [{r: 1., g: 0., b: 1.}, {r: 0., g: 1., b: 0.}, {r: 0., g: 0., b: 1.}],
  [{r: 1., g: 1., b: 0.}, {r: 0., g: 1., b: 1.}, {r: 0.5, g: 1., b: 0.}],
];
...
let shaderCPArray = [].concat(...shaderCPMatrix);
...
const gradientMeshShader = {
  ...
  uniforms: {
    ...
    "coefficientsU": { type: "f[]", value: [1., 2., 1.] },
    "coefficientsV": { type: "f[]", value: [1., 2., 1.] },
  ...
  fragmentShader: [
    ...
    `#define N ${shaderCPMatrix.length}`,
    `#define M ${shaderCPMatrix[0].length}`,
